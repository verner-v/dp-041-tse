<h2 class="a-center">Добавить пользователя-исполнителя</h2>

<?php echo form::open('admin/performeruseradd'); ?>
	...
	<div class="col-right-70">
   		<?php echo form::select('contractor_id',array_combine($arr_contractor_id,$arr_contractor_name),'',array('id'=>'contractor_id','class'=>'jqtestcontractorclass')); ?>
	</div>
	
	<div class="col-left-30">
		<?php echo form::label('performer_id','Исполнитель:'); ?>
	</div>

	<div class="col-right-70">
   		<?php echo form::select('performer_id',array('-1'=>'Выберите'),'',array('id'=>'performer_id')); ?>
	</div>
